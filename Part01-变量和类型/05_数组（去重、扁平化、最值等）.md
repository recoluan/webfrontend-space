...
# 常见面试题
## 数组中用过哪些方法？
1. splice 和 slice 的区别
2. push、pop、unshift、shift 的区别
3. filter、map、find、forEach 的区别
4. split 和 join 的区别（反转）
5. for-in、for-of、for、forEach 的区别
